...
public class ClassLoaderUsage {
    ...
    public static void main(String[] args) throws MalformedURLException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        print(printer , urlClassLoader , new String[]{"com.liuyu.common.util.classloader.ClassLoaderPrinter" , 
        ...
        print(printer , urlClassLoader , new String[]{"com.liuyu.learn.apache.attributes.AttributesCode" , 
